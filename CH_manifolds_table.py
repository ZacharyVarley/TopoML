...
def format_latex_table(metrics_df: pd.DataFrame) -> str:
    ...
    latex_output += "\\caption{\\textbf{Cahn-Hilliard Manifold Analysis.} "
    ...
    latex_output += "The bottom table presents continuity and distortion metrics with 95\\% confidence intervals. "
    ...
    latex_output += "\\label{tab:ch_manifolds}\n"
